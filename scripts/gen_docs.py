...
CONTRACT = """pub enum Scope { Http(HttpScope)  WebSocket(WebSocketScope)  Lifespan(LifespanScope) }
...
def main():
    HEAD = ('<!doctype html><html lang="en"><head><meta charset="utf-8">'
            ...
            '<title>moonasgi — MoonBit ASGI 3.0 API</title>'
    ...
    side = ['<aside class="sidebar"><div class="brand"><span class="dot"></span>moonasgi</div>'
            '<p class="brand-sub">MoonBit ASGI 3.0 — SEAM reference</p><nav class="side-nav">']
    ...
    side += ['</nav>'
             ...
             '<a href="https://mooncakes.io/docs/Lfan-ke/moonasgi"><img alt="mooncakes" src="https://img.shields.io/badge/mooncakes-Lfan--ke%2Fmoonasgi-1f6feb"></a>'
             '</div></aside>']

    hero = ('<main><header class="hero"><h1>moonasgi</h1>'
            '<p class="tag">MoonBit-dialect ASGI 3.0 — the load-bearing server&#8596;app seam every server '
            'and framework in the moon* full-stack suite is built around. One typed contract isolates async '
            ...
            '<button class="copy" data-copy="moon add Lfan-ke/moonasgi">copy</button></div>'
    ...
    body.append('<footer>Generated from source <code>///</code> doc-comments · '
                '<a href="https://mooncakes.io/docs/Lfan-ke/moonasgi">mooncakes</a> · '
                '<a href="https://github.com/Lfan-ke/moonasgi">GitHub</a> · Apache-2.0 &#169; Leo Cheng</footer>')
